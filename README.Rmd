...
The visit schedule for tumor assessments is every 4 weeks (in `schedule`).  Median PFS for the two treatment groups (Sip-T and Placebo) are 12 and 10 months respectively.
